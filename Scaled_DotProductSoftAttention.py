...
class ScaledDotProductSoftAttention(keras.layers.Layer):
    ...
    def __init__(self,
        ...
        """
        super(ScaledDotProductSoftAttention, self).__init__(**kwargs)
    ...
    def get_config(self):
        ...
        base_config = super(ScaledDotProductSoftAttention, self).get_config()
    ...
    def compute_output_shape(self, input_shape):
        if isinstance(input_shape, list):
            ...
            query_shape = key_shape = input_shape
        output_shape = query_shape[:2] + (key_shape[1],)
        return output_shape
