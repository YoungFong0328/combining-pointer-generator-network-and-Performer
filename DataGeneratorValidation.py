...
class DataGeneratorValidation(keras.utils.Sequence):
    ...
    def __init__(self, input_databuffer_params,output_databuffer_params, list_IDs,  batch_size=64, total_error_types=36, max_text_len=999, shuffle=True):
        ...
        self.dbx1 = db.DataBuffer(data_path[0], data_number[0], data_type[0], block_size[0], file_name="x_validation[0]_", max_seq_len=max_text_len )
        self.dbx2 = db.DataBuffer(data_path[1], data_number[1], data_type[1], block_size[1], file_name="x_validation[1]_", max_seq_len=max_text_len )
        ...
        self.dby2 = db.DataBuffer(data_path[1], data_number[1], data_type[1], block_size[1], file_name="y_validation[1]_", max_seq_len=max_text_len )
